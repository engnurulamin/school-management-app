...
-- AddForeignKey
ALTER TABLE "Exam" ADD CONSTRAINT "Exam_lessonIs_fkey" FOREIGN KEY ("lessonIs") REFERENCES "Lesson"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
