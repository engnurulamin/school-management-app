      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="bg-Sky px-8 py-4 rounded-md flex-1 flex gap-4">
            <div className="w-1/3">
              <Image
                src="https://images.pexels.com/photos/459335/pexels-photo-459335.jpeg"
                alt="Teacher"
                height={144}
                width={144}
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <h1 className="text-xl font-semibold">Tabassum Naja</h1>
              ...
              <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
                ...
                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                  ...
                  <span className="whitespace-nowrap">12-05-2024</span>
                </div>
                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                  <Image src="/mail.png" alt="Mail" width={14} height={14} />
                  <span className="whitespace-nowrap">user@mail.com</span>
                </div>
                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
        ...
        <div className="mt-4 bg-white p-4 rounded-md h-[800px]">
          <h1 className="text-xl font-semibold">Student&apos;s Schedules</h1>
          <BigCalender />
        </div>
      </div>
      {/*  */}
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link className="p-3 rounded-md bg-Sky" href="/admin">
              Student&apos;s Lessons
            </Link>
            <Link
              className="p-3 rounded-md bg-PurpleLight"
              href={`/list/teachers?classId=${200}`}
            >
              Student&apos;s Teachers
            </Link>
